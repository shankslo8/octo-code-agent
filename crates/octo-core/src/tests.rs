...
mod tests {
    ...
    fn test_model_registry() {
        ...
        let glm = models.get(&ModelId("zai-org/glm-4.7".into()));
        assert!(glm.is_some());
        let glm = glm.unwrap();
    ...
    fn test_model_cost_calculation() {
        let model = get_model(&ModelId("zai-org/glm-4.7".into())).unwrap();
        // 1000 input tokens, 500 output tokens
        let cost = model.calculate_cost(1000, 500);
        // (1000/1M * 0.52) + (500/1M * 2.56) = 0.00052 + 0.00128 = 0.0018
        assert!((cost - 0.0018).abs() < 0.0001);
    }

    #[test]
    fn test_all_five_models_exist() {
        let ids = [
            "zai-org/glm-4.7",
    ...
    fn test_default_model() {
        ...
        assert_eq!(model.id.0, "zai-org/glm-4.7");
    }
    ...
    fn test_config_defaults() {
        ...
        assert_eq!(config.agent.coder_model.0, "zai-org/glm-4.7");
