#[cfg(test)]
mod tests {
    use octo_core::team::TeamState;
    use octo_core::tool::{Tool, ToolCall, ToolContext};
    ...
    fn test_tool_definitions() {
        use crate::*;
        use octo_core::permission::PermissionService;
        use std::sync::Arc;
        ...
        impl PermissionService for MockPerm {
            async fn request(
                &self,
                _req: octo_core::permission::PermissionRequest,
            ) -> octo_core::permission::PermissionDecision {
                octo_core::permission::PermissionDecision::Allow
            }
        ...
        assert!(names.contains(&"coderlm".to_string()));
        // Team tools
    ...
    fn test_coderlm_tool_definition() {
        let tool = crate::CoderlmTool::new("http://127.0.0.1:9999".into());
        let def = tool.definition();
    ...
    async fn test_coderlm_server_unavailable() {
        ...
        let tool = crate::CoderlmTool::new("http://127.0.0.1:19999".into());
    ...
    async fn test_write_and_edit_tools() {
        use octo_core::permission::{PermissionDecision, PermissionService};
        use std::sync::Arc;
        ...
        // Test write
        let write_tool = crate::WriteTool::new(perm.clone());
        ...
        // Test edit
        let edit_tool = crate::EditTool::new(perm.clone());
        let call = ToolCall {
            id: "2".into(),
            name: "edit".into(),
            input: serde_json::json!({
    ...
    async fn test_edit_tool_not_unique() {
        ...
        let edit_tool = crate::EditTool::new(perm);
        let call = ToolCall {
            id: "1".into(),
            name: "edit".into(),
            input: serde_json::json!({
    ...
    async fn test_bash_safe_command() {
        ...
        let bash_tool = crate::BashTool::new(perm);
        let call = ToolCall {
            id: "1".into(),
            name: "bash".into(),
    ...
    async fn test_team_create_and_delete_lifecycle() {
        ...
        // Create team
        let tool = crate::TeamCreateTool::new(ts.clone());
        let call = ToolCall {
            id: "1".into(),
        ...
        // Delete team
        let del_tool = crate::TeamDeleteTool::new(ts.clone());
        let call = ToolCall {
            id: "2".into(),
    ...
    async fn test_task_crud_lifecycle() {
        ...
        // Create task
        let create_tool = crate::TaskCreateTool::new(ts.clone());
        let call = ToolCall {
            id: "1".into(),
        ...
        // Get task
        let get_tool = crate::TaskGetTool::new(ts.clone());
        let call = ToolCall {
            id: "2".into(),
            name: "task_get".into(),
        ...
        // Update task
        let update_tool = crate::TaskUpdateTool::new(ts.clone());
        let call = ToolCall {
            id: "3".into(),
        ...
        // List tasks
        let list_tool = crate::TaskListTool::new(ts.clone());
        let call = ToolCall {
            id: "4".into(),
            name: "task_list".into(),
            input: "{}".into(),
    ...
    async fn test_send_message_inbox() {
        ...
        let config = octo_core::team::TeamConfig {
            name: "test-team".into(),
            description: "".into(),
            created_at: chrono::Utc::now(),
            lead_agent_id: "test-lead@test-team".into(),
            members: vec![
                octo_core::team::TeamMember {
        ...
        octo_core::team::write_team_config(tmp.path(), "test-team", &config).unwrap();

        // Send direct message
        let tool = crate::SendMessageTool::new(ts.clone());
        let call = ToolCall {
            id: "1".into(),
        ...
        // Verify inbox file
        let inbox = octo_core::team::read_inbox(tmp.path(), "test-team", "worker").unwrap();
    ...
    async fn test_check_inbox() {
        ...
        let tool = crate::CheckInboxTool::new(ts.clone());
        let call = ToolCall {
            id: "1".into(),
        ...
        let msg = octo_core::team::InboxMessage {
            from: "worker".into(),
            text: "Task done!".into(),
            timestamp: chrono::Utc::now(),
            read: false,
        };
        octo_core::team::append_inbox(tmp.path(), "test-team", "test-lead", msg).unwrap();
