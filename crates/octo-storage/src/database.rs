...
use octo_core::error::StorageError;
...
impl Database {
    ...
    pub fn sessions(&self) -> crate::SessionRepo {
        crate::SessionRepo::new(self.pool.clone())
    }

    pub fn messages(&self) -> crate::MessageRepo {
        crate::MessageRepo::new(self.pool.clone())
    }
